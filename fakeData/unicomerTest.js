      ...
      this.database.findData('unicomer', 'Branch__c', {'Branch_Group_Members__r': {$ne: null}}).then(result => {
        ...
        for (let i = 0; i < numberOfAccounts; i++) {
          ...
          let account = {
            ...
            'Branch__r.Branch_Code__c' : this.assignBranch(),
  ...
  createFakeB2BAccounts = (numberOfAccounts) => {
    ...
    for (let i = 0; i < numberOfAccounts; i++) {
      ...
      let fakeAccount = {
        ...
        "Other Phone": faker.phone.number('##########'),
        ...
        "Mailing Country": faker.address.country(),
        "Mailing State/Province": faker.address.state(),
        "Mailing City": faker.address.city(),
        "Mailing Street": faker.address.street(),
        "Mailing Zip/Postal Code": faker.address.zipCode('######'),
        ...
        "Other Country": faker.address.country(),
        "Other State/Province": faker.address.state(),
        "Other City": faker.address.city(),
        "Other Street": faker.address.street(),
        "Other Zip/Postal Code": faker.address.zipCode('######'),
        ...
        "Mailing Geocode Accuracy": "Street",
        "Other Geocode Accuracy": "Street",
        ...
        "Score Risk Class": 5,
        "Total Credits": faker.datatype.number({ min: 1000, max: 100000, precision: 0.01 }),
        ...
        "Total Active Credits": faker.datatype.number({ min: 1000, max: 100000, precision: 0.01 }),
        "Current combine instalment": faker.datatype.number({ min: 1000, max: 100000, precision: 0.01 }),
        "RfavailablePercent": faker.datatype.number({ min: 1000, max: 100000, precision: 0.01 }),
        "RfavailablePercent Fixed Value": faker.datatype.number({ min: 1000, max: 100000, precision: 0.01 }),
